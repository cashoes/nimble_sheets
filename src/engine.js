...
function renderInventory(statsMap, armorVal, str, iStats) {
    ...
    let invHtml = `<div class="inv-header"><div></div><div style="text-align:center;">Effect</div><div>Item</div><div style="text-align:center;">Type</div><div style="text-align:center;">Stats</div><div style="text-align:center;">Description</div><div style="text-align:center;">GP</div><div style="text-align:center;">Wt</div><div></div></div>`;
