...
function loadState() {
    state = {
        version: "1.4.0", charName: '', level: 1, ancestry: 'None', background: 'None', subclass: 'None',
...
function defaultGetFeaturesHTML(level, subclass, state, derived, bFeat, iStats, formatPips, rSSC, featuresRef, optionsRef, configRef) {
    ...
    const renderFn = configRef.renderFeature || defaultRenderFeature;
